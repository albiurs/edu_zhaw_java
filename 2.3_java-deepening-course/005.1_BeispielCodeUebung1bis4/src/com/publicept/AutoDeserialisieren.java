...
public class AutoDeserialisieren {
  ...
  public static void main(String[] args) {
    ...
    try (FileInputStream fis = new FileInputStream("/Volumes/GoogleDrive/My Drive/homes/alu/my_docs/dev/intellij-projects/edu_zhaw-advanced-java-course/005.1_BeispielCodeUebung1bis4/serialize/auto.ser");
